...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("agents", "Show active agents and running tasks", "Session",
               aliases=("tasks",)),
    CommandDef("activity", "Show live work plus Linear started issues", "Session",
               gateway_only=True),
    CommandDef("linear", "Manage Linear link for this chat/session", "Session",
               gateway_only=True,
               args_hint="[show|attach <issue>|detach|comment <text>|started|whoami]",
               subcommands=("show", "attach", "detach", "comment", "started", "whoami")),
